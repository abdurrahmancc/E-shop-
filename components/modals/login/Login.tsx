...
const Login = ({ setIsLogin, isLogin }: Props) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <div className="min-h-[643px] max-h-[677px] h-full lg:max-w-[564px] md:max-w-[500px] sm:max-w-[450px] max-w-[350px] rounded-[16px] w-full bg-white bg-cover bg-no-repeat">
