...
import banner2 from "../../assets/banner/banner-3-2.png";
import banner3 from "../../assets/banner/banner-3-3.png";
              ...
              <div className="absolute top-0 h-full flex items-center">
                <div className="text-start max-w-[300px] sm:max-w-[400px] md:max-w-[450px] lg:max-w-[580px]">
                  ...
                  <Fade bottom delay={600}>
                    <button
                      onClick={() => push("/shop/1")}
                      className="xl:w-[189px] w-[120px] text-[14px] md:w-[150px] font-[500] xl:text-[20px] md:text-[18px] leading-[30px] bg-gradient-to-r from-[#0881f3] to-[#0881f3] btn-animate rounded-[48px] xl:h-[62px] h-[46px] md:h-[50px] bg-info text-neutral "
                    >
                      Shop Now
                    </button>
                  </Fade>
            ...
            <div className="max-w-[1443px] container w-full mx-auto px-4 lg:px-10 2xl:px-0">
              <div className="absolute top-0 h-full flex items-center">
                <div className="text-start max-w-[300px] sm:max-w-[400px] md:max-w-[450px] lg:max-w-[580px]">
                  <Fade top delay={300}>
                    <div className="flex gap-4 items-center">
                      <div className="w-[82px] h-[1px] bg-[#fFFFFF]"></div>
                      <span className="text-[16px] leading-[24px] font-[500] text-[#FFFFFF]">
                        BIG SAVING
                      </span>
                    </div>
                  </Fade>
