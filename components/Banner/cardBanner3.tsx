...
import banner1 from "../../assets/banner/card-banner-7.png";
import banner2 from "../../assets/banner/card-banner-8.png";
import banner3 from "../../assets/banner/card-banner-9.png";
