...
const SmartBanner4 = () => {
  return (
    <div className="relative">
      <Image src={img} width={1440} height={154} className="" alt="discount banner" />
      <div className="absolute flex justify-center items-center top-0 h-full w-full">
        <div className="text-center">
          <Fade top delay={100}>
            <p className="text-[16px] text-center leading-[24px] text-[#FFFFFF] ">
              Get Discount On 30% Offer
            </p>
          </Fade>
          <Fade bottom delay={100}>
            <h5 className="text-[24px] leading-[36px] text-center  font-[600] text-white">
