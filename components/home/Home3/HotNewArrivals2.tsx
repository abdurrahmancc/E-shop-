...
const HotNewArrivals2 = ({ products }: Products) => {
  ...
  return (
    <>
      ...
      <div className="mt-[50px] flex lg:flex-row flex-col items-center lg:items-start gap-y-8 gap-x-5 2xl:gap-x-[30px]">
        <div className="2xl:w-[557px] mt-5 order-2 lg:order-1 lg:mt-0 xl:w-[420px] md:w-[558px] sm:w-[500px] max-h-[905px] h-[905px] rounded-[8px]">
