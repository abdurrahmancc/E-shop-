...
const SpecialSec = () => {
  return (
    <div
      id="special-Sec"
      className="max-w-[1443px] h-full container w-full mx-auto px-4 lg:px-10 2xl:px-0"
    >
      <div className="2xl:pb-[85px] xl:pb-10 lg:pb-[85px] md:pb-5 pb-10  justify-center mx-auto 2xl:gap-[30px] lg:gap-5 md:gap-4 h-full flex items-end">
        ...
        >
          <div className="flex relative flex-col items-center">
            <div className="flex xs-top absolute w-full justify-end pr-6 pt-[23px]">
            ...
            <figure className="lg:mt-14 xs-special-Sec mt-12">
              <Image
                src={img}
                width={309}
                height={309}
            ...
            <div className="px-5 xs-body-top lg:mt-2 pb-4 md:mt-0 mt-2">
              <h3 className="2xl:text-[24px] xl:text-[20px] xl:leading-[28px] lg:text-[24px] lg:leading-[36px] md:text-[20px] md:leading-[28px] mb-[12px] text-secondary 2xl:leading-[36px] font-[600] text-center sm:text-[24px] sm:leading-[36px] text-[18px] leading-[28px] xs-title">
