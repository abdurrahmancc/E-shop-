  ...
  return (
    <>
      ...
      <div className="form-control">
        <label className="label px-0 pt-0">
          <span className="text-[16px] text-[#424242] leading-[24px]">Order notes (optional)</span>
        </label>
        <textarea
          id="orderNotes"
          className="textarea textarea-bordered border-[#D9D9D9] rounded-none h-[144px]  w-full text-[16px] leading-[22px] text-black bg-[#ffffff] focus:outline-none "
          {...register("orderNotes")}
        />
      </div>
    </>
