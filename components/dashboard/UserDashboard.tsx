  ...
  return (
    <DashboardLayout>
      <div className="w-full pt-[14px]">
        <h2 className="text-[#031424] text-[20px] leading-[30px] font-[600]">Trending Products</h2>
        ...
        <div className="mt-10">
          <h6 className="text-[#031424] leading-8">
            ...
            <span className="font-[500]">James_Smith?</span>{" "}
            <span className="text-info cursor-pointer">Log out</span>)
          </h6>
          <p className="text-[16px] mt-2 leading-8 ">
            From your account dashboard you can view your{" "}
            <span className="text-info font-[500]">recent orders</span>, manage your{" "}
            <span className="text-info font-[500]">shipping and billing addresses</span>, and{" "}
            <span className="text-info font-[500]">edit your password and account details</span>.
          </p>
        </div>
      </div>
    </DashboardLayout>
